...
def run_build():
    os.system('rm -rf {}/out/rk3588 {}/out/preloader'.format(OH_ROOT, OH_ROOT))
    ret = os.system('cd {} && ./build.sh --product-name dayu210 --ccache --gn-args "allow_sanitize_debug=true" > {} 2>&1'.format(OH_ROOT, BUILD_LOG))
    return ret
